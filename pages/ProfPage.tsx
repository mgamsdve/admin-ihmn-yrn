...
export default function StudentDataGrid() {
    ...
    const handleRowClick = (params) => {
        router.push(`/users/${params.row.id}/ProfDetail`)
    }
    ...
    async function handleDeleteUsers(e) {
        if (confirm('Voulez-vous vraiment supprimer ces prof ?')) {
            await deleteDocuments('profs', selectedIds)
            alert('Les prof ont été supprimés')
        } else {
    ...
    const columns = [
        ...
        { field: 'prename', headerName: 'Nom', width: 130, editable: true },
        ...
        <div className="w-full h-screen bg-gray-50">
            <div className="p-5 w-full">
                ...
                >
                    ...
                    <DialogContent>
                        <NewProfessorDialogContent handleClose={handleClose} />
                    </DialogContent>
                </Dialog>
            </div>
        </div>
